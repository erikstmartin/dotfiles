---
name: cartography
description: Use to map or understand a repository: generate codemaps, architecture overviews, or codebase documentation. Triggers include "map the codebase", "codemap", or "architecture overview".
---
